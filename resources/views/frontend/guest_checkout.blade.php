...
<!-- Main Container  -->
        <div class="main-container container">
            ...
            <form action="{{ ('guest_order') }}" method="POST">
                @csrf
                                ...
                                <div class="panel-body">
                                    <fieldset id="address" class="required">
                                        ...
                                        <div class="form-group required">
                                            ...
                                            <input type="text" class="form-control1" id="input-payment-company"  value="" name="name" required>
                                        </div>

                                        <div class="form-group required">
                                            <label for="input-payment-company" class="control-label">Phone</label>
                                            <input type="text" class="form-control1" id="input-payment-company"  value="" name="phone" required>
                                        </div>

                                        <div class="form-group required">
                                            <label for="input-payment-address-1" class="control-label">Address</label>
                                            <textarea row="4" name="address" class="form-control1" required></textarea>
                                        </div>

                                        <div class="form-group required">
                                            <label for="input-payment-city" class="control-label">City</label>
                                            <input type="text" class="form-control1" id="input-payment-city"  value="" name="city" required>
                                        </div>
