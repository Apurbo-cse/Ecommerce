...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="/">Shah Ali Plaza</a>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/vendor_item">Show Product</a>
                                    <a class="nav-link" href="/vendor_add-item">Add Product</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link" href="/vendor_order">
                            ...
                            <a class="nav-link" href="/vendor-payment">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Payments
                            </a>
