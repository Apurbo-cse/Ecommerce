    ...
    <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <form action="{{ url('update_item/'. $product->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="brand">
                                                ...
                                                @foreach($brand as $data)
                                                    <option value="{{ $data->id }}" {{ $product->brand_id == $data->id ? 'selected' : ' ' }}>{{ $data->name }}</option>
                                                @endforeach
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <img src="{{ asset('uploads/item/extra1/'.$product->photo1) }}" alt="" height="250" width="200">
                                            <label class="form-check-label" for="exampleCheck1">Extra Image 1</label>
                                            <input type="file" class="form-control" name="file1">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <img src="{{ asset('uploads/item/extra2/'.$product->photo2) }}" alt="" height="250" width="200">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <!---
                                        <div class="form-group">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name="latest" {{ $product->latest == '1' ? 'checked' : ' ' }}>
                                            <label class="form-check-label" for="exampleCheck1">Latest</label>
                                        </div>
                                        <div class="form-group">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name="featured" {{ $product->featured == '1' ? 'checked' : ' ' }}>
